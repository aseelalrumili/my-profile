...
export const createProject = async (formData: FormData): Promise<Project> => (await API.post('/projects', formData)).data;
export const updateProject = async (id: number, formData: FormData): Promise<Project> => (await API.put(`/projects/${id}`, formData)).data;
